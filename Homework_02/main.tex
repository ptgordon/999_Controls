...
% resolution:  \answerfigure[0.8\linewidth]{figures/2_B_Schematic.png}{...}
...
\answerfigure[0.8\linewidth]{figures/2_B_Schematic.png}{The two-mass system of Problem 1.B.}
\answer{
\[A=b+a\]

The difference in velocities between $m_1$ and $m_2$ will decay because $b_2$ scales with velocity. Since their is no friction, the output $x_2(t)$ will not decay.}
