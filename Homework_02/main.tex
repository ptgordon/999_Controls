...
\answer{The difference in velocities between $m_1$ and $m_2$ will decay because $b_2$ scales with velocity. Since their is no friction, the output $x_2(t)$ will not decay.}
